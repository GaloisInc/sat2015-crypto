...
public class SHA1PRNG_SecureRandomImpl_JellyBean {
     ...
     */
    public SHA1PRNG_SecureRandomImpl_JellyBean() {
    ...
    public void engineNextBytes(byte[] bytes) {
        ...
        if (state == UNDEFINED) {
            ...
            // NB: here's where the randomness comes from. We care whether it
            // all gets used. That is, do different random values always lead to
        ...
        for (;;) {
            ...
            Symbolic.writeAiger("jellybean_prng.aig", seedInit);
    ...
    public static void main(String[] args) {
        ...
        SHA1PRNG_SecureRandomImpl_JellyBean prng = new SHA1PRNG_SecureRandomImpl_JellyBean();
